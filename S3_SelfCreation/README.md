...
The goal of the project is to create a micro-creation based on the knowledge learned from the first two topics.

### Usage ###

This code creates a renderer, a scene, a camera, a loader, a control, a starField, and a clock cube, and it adds the cube to the scene.
