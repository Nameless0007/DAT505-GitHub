# Closing Homework #
* According to the requirements of the document, I did the homework as required.
...
```
* This is from the CSS file. The main function of the CSS file is to control the content of relevant documents in the program. In this program, this part is mainly reflected in the sequence number of cubes. CSS can control text size, color, location and other content.
...
drawFrame();
```
* This project mainly allows us to review most of what we have learned before. Most of the parts I didn't understand were solved. I think the part about CSS is the most difficult because we haven't studied this part in depth in class, but eventually I finished one part with the help of my classmates. The next link is the reference I looked for on the internet.[https://www.csdn.net/].
