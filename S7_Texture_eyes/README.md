...
The aim of this project is to realize that the eyeball also rotates in the direction of the mouse as the mouse moves.

### Usage ###

This code creates a scene, a camera, a renderer, a mesh, a image and a container cube, and it adds the cube to the scene.
